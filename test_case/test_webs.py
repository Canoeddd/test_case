...
from py_page.temu_p_webs import TemuWebs
from page_locator.public import des1, des2, link_webs, code_webs
...
class TestWebs():
    ...
    def test_first_coupon(self):
        ...
        try:
            ...
            print(affi_code1)
            assert affi_code1 == code_webs, f"WA0301-webs的第一个affi-Code错误"        # 第一张coupon的code码断言

            store_detail.copy_code()
            affi_code1_link = store_detail.code_link()
            assert affi_code1_link == link_webs, f"WA0301-webs的第一个affi-link错误"
    ...
    def test_sec_coupon(self):
        ...
        try:
            ...
            print(affi_code2)
            assert affi_code2 == code_webs, f"WA0301-webs的第二个affi-Code错误"        # 第二张coupon的code码断言

            store_detail.copy_code()
            affi_code2_link = store_detail.code_link()
            assert affi_code2_link == link_webs,  f"WA0301-webs的第二个affi-link错误"
